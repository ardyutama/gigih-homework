...
export default function index({onChange,onClick}) {
    return (
        <div className="flex pr-5 py-6">
            <input label="search" onChange={onChange} placeholder="Search Song" type="text" className="px-4 rounded-lg block focus:border-black-spotify focus: ring-1 focus:ring-black-spotify focus:outline-none"/>
